...
<div class="comment_list__block swiper-container">
    ...
    <div class="test123" style="display:none;"> <?echo '<pre>'; print_r($comments); echo '</pre>';?></div>
...
<?php wp_nav_menu( array('menu' => 'topmenu-2' )); ?>
            </nav>
<script >
...
<div class="vrs5">
    <div class="vrs5__left">
        ...
        <a class="lg" href="/">БалкСтрой<span class="lgsp">ОСТЕКЛЕНИЕ БАЛКОНОВ</span><span class="lgsp2">Квалифицированный подход любой сложности</span></a>
    ...
    <div class="tpphn">
        ...
        <span class="tpphn__info">
            <span class="tpphn__info-email">balkstroy@yandex.ru</span>
...
$(document).ready(function() {
    ...
    $('body').click('#commentform #submit', function(){
