...
function twentyfourteen_setup() {
	...
	register_nav_menus( array(
		...
		'footer_1' => __( 'footer_1', 'twentyfourteen' ),
		'footer_2' => __( 'footer_1', 'twentyfourteen' ),
		'footer_3' => __( 'footer_1', 'twentyfourteen' ),
	) );
...
<li <?php comment_class('clearfix'); ?> id="li-comment-<?php comment_ID() ?>">
    <div id="comment-<?php comment_ID(); ?>" class="<? if ($args['has_children']==0) {  echo 'review_item'; }?>">
        <div class="comment-meta commentmetadata clearfix">
            <?php if ( get_comment_author_link() == 'master') : ?>
            <span class="autor_name">
                <? echo "Двери Плюс"; ?>
            </span>
            <? else : ?>
            <span
                class="autor_name"><?php printf(__('%s'), get_comment_author_link()) ?></span><?php edit_comment_link(__('(Edit)'),'  ','') ?>,
            <span class="date"><?php printf(__('%1$s'), get_comment_date('d.m.Y')) ?>
                <?php endif; ?>
            </span>
        </div>
        <?php if ( get_comment_author_link() == 'master') : ?>
...
function balkon_comment( $comment, $args, $depth ){	?>
		<li id="comment-<?php comment_ID() ?>" class="comment even thread-even depth-1 swiper-slide">
			<div id="div-comment-<?php comment_ID() ?>" class="comment-body">
				...
				<div class="comment-author vcard">
					<?php echo get_avatar( $comment, 35, '', '', array( 'class' => 'avatar avatar-32 photo comment-avatar' ) ) ?>
					<!-- <img alt="" src="https://secure.gravatar.com/avatar/7a1cd4495b8e7140f77b6ebdf63cc090?s=32&amp;d=https%3A%2F%2Fsecure.gravatar.com%2Favatar%2Fad516503a11cd5ca435acc9bb6523536%3Fs%3D32&amp;r=G" class="avatar avatar-32 photo" height="32" width="32">  -->
						<b class="fn">
							<a href="https://systemssec.ru" rel="external nofollow" class="url"><?php comment_author() ?></a>
						</b>
