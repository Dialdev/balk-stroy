...
* Minor fix for lite version

= 3.2 =

* Guest account option issue resolved for lite version. No changes in Full version.

= 4.0 =

* Major Security issue resolved for both lite and full version
* Disabled the option to add user with any permission to select as default guest user. Only users with "Author" permissions can be selected as default guest author.
* phone custom field was missing in the previous version which can be used now if its allowed by admin
