...
//$comment_content = preg_replace ("(.ru|.com|.net|www.|https?://?(([-\w]+\.)+([^\s]+)+[^,.\s])|http?://?(([-\w]+\.)+([^\s]+)+[^,.\s]))", '', $comment_content);
if(preg_match("(.ru|.com|.net|www.|https?://?(([-\w]+\.)+([^\s]+)+[^,.\s])|http?://?(([-\w]+\.)+([^\s]+)+[^,.\s]))", $comment_content)){
	wp_die( __('<strong>ERROR</strong>: Don`t add any links.') );
}
if ( '' == $comment_content )
