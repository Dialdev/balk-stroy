...
(function(){
    ...
    document.querySelector('#balconCalc').addEventListener('change', function () {
        ...
        var calculatedSquare = function () {
            ...
            square.setAttribute('placeholder', squareTotal + ' м.кв.');
        ...
        var calcInnerPrice = function () {
            ...
            totalInnerFinish.textContent = squareTotal;
            totalInnerPrice.value = innerTotalPrice;
        };
        ...
        var calcOuterPrice = function () {
            ...
            outerTotalPrice = squareTotal * Number(outerPriceVal.value);
            totalOuterFinish.textContent = squareTotal;
            totalOuterPrice.value = outerTotalPrice;
        };
